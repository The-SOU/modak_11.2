package com.modak.modaktestone.navigation.recyclerView
...
class DetailSocietyXRecyclerViewAdapter: RecyclerView.Adapter<DetailSocietyXRecyclerViewAdapter.CustomViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): DetailSocietyXRecyclerViewAdapter.CustomViewHolder {
        val binding =
    ...
    override fun onBindViewHolder(
        holder: DetailSocietyXRecyclerViewAdapter.CustomViewHolder,
        position: Int
    ) {
